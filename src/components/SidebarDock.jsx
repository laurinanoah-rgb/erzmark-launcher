...
export function GalleryTabIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export function ProfilesTabIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
 ...
 * SocialDock.jsx.
 */
export function getWorldDockModules() {
  return [
    { id: "news", label: "Herold", Icon: NewsTabIcon, color: "blue", content: <NewsFeed /> },
    { id: "profiles", label: "Chroniken", Icon: ProfilesTabIcon, color: "gold", content: <CharacterProfiles /> },
    { id: "gallery", label: "Erinnerungen", Icon: GalleryTabIcon, color: "green", content: <ScreenshotGallery /> },
  ];
}

export default function SidebarDock() {
  const tabs = getWorldDockModules();
