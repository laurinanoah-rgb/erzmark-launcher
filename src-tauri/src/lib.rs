...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            game_commands::get_screenshot_data_url,
            ...
            skin_commands::list_skin_vault,
            skin_commands::save_skin_to_vault,
            skin_commands::apply_vault_skin,
            skin_commands::delete_vault_skin,
            skin_commands::open_skin_vault_folder,
